...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: BankModel[]) => {
  ...
  onDelete=  (data: BankModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: BankModel = data // Example data to send
