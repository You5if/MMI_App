...
@Component({
  ...
  styleUrl: './stock-return.component.css'
})
...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  constructor(
    private loanService: StockReturnService,
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: StockReturnModel[]) => {
  ...
  onDelete=  (data: StockReturnModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: StockReturnModel = data // Example data to send
