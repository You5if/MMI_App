...
export class StockMoveComponent {
  ...
  pTableId: number = 0;
  pUserId: number = 1;
  displayedColumns: string[] = ['select', 'journCode', 'journDate', 'tax', 'warehouse2','remarks'];
  dataSource: any;
  isLastPage = false;
...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData).subscribe((result: StockMoveModel[]) => {
