...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  constructor(
    private allowanceService: WarehouseService,
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: WarehouseModel[]) => {
  ...
  onDelete=  (data: WarehouseModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: WarehouseModel = data // Example data to send
