...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  constructor(
    private allowanceService: CustomerService,
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: CustomerModel[]) => {
  ...
  onDelete=  (data: CustomerModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: CustomerModel = data // Example data to send
