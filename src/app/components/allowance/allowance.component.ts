...
@Component({
  ...
  styleUrl: './allowance.component.css'
})
...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: AllowanceModel[]) => {
  ...
  onDelete=  (data: AllowanceModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: AllowanceModel = data // Example data to send
