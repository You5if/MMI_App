...
import { CostCenterAccModel } from './cost-center-account.model';
...
@Component({
  selector: 'app-cost-center-account',
  templateUrl: './cost-center-account.component.html',
  styleUrl: './cost-center-account.component.css'
})
export class CostCenterAccountComponent {
...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  constructor(
    private allowanceService: CostCenAccterAccountService,
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: CostCenterAccModel[]) => {
  ...
  onDelete=  (data: CostCenterAccModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: CostCenterAccModel = data // Example data to send
