...
import { ChartOfAccountsModel } from './chart-of-accounts.model';
...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  constructor(
    private holidayService: ChartOfAccountsService,
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: ChartOfAccountsModel[]) => {
  ...
  onDelete=  (data: ChartOfAccountsModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: ChartOfAccountsModel = data // Example data to send
