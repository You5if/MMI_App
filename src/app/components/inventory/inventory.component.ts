...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  constructor(
    private holidayService: InventoryService,
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: InventoryModel[]) => {
  ...
  onDelete=  (data: InventoryModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: InventoryModel = data // Example data to send
