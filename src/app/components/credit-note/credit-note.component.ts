...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  constructor(
    private allowanceService: CreditNoteService,
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: CreditNoteModel[]) => {
  ...
  onDelete=  (data: CreditNoteModel) => {
    // this.router.navigate(['/user']);
    // console.log(this.firstName);
    var dataToSend: CreditNoteModel = data // Example data to send
