...
@Component({
  ...
  templateUrl: './day-working-hours.component.html',
  styleUrl: './day-working-hours.component.css'
})
export class DayWorkingHoursComponent {
  ...
  constructor(
    private dwhService: DayWorkingHoursService,
