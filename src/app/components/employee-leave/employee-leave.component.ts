...
import { EmpLeaveModel } from './employee-leave.model';
...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  constructor(
    private holidayService: EmployeeLeaveService,
  ...
  refreshMe() {
    ...
    this._cf.newGetPageData(this.pTableName, this.pageData, this.sort, this.filter).subscribe((result: EmpLeaveModel[]) => {
  ...
  onDelete=  (data: EmpLeaveModel) => {
    ...
    var dataToSend: EmpLeaveModel = data // Example data to send
